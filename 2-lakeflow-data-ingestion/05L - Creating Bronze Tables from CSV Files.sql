...
-- MAGIC   - Read in CSV files as a Delta table and append metadata columns.
...
-- MAGIC         DA.paths_working_dir || '/csv_demo_files/lab_malformed_data.csv',
-- MAGIC         format => "csv",
-- MAGIC         sep => ",",
-- MAGIC         header => true,
-- MAGIC         schema => '''
...
-- MAGIC DROP TABLE IF EXISTS 05_lab_bronze;
-- MAGIC
-- MAGIC ---- Create the Delta table
-- MAGIC CREATE TABLE 05_lab_bronze 
-- MAGIC AS
-- MAGIC SELECT
-- MAGIC   *,
...
-- MAGIC %skip
-- MAGIC CREATE OR REPLACE TABLE 05_lab_challenge
-- MAGIC SELECT
-- MAGIC   item_id,
-- MAGIC   name,
-- MAGIC   price,
